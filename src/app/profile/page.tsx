                        ...
                        bookings?.map((booking: any) => {
                            return (
                                <div className='booking' key={booking && booking._id}>
                                    <div className='detail'>
                                        <h3>Movie</h3>
                                        <p>{booking ? booking.movieId : 'No movie selected'}</p>
                                    </div>


                                    <div className='detail'>
                                        <h3>Screen</h3>
                                        <p>{booking ? booking.screenId : 'No screen selected'}</p>
                                    </div>
                                    ...
                                    <div className='detail'>
                                        <h3>Price</h3>
                                        <p>{booking ? booking.totalPrice : 'N/A'}</p>
                                    </div>

                                    <div className='detail'>
                                        <h3>Payment Type</h3>
                                        <p>{booking ? booking.paymentType : 'N/A'}</p>
                                    </div>

                                    <div className='detail'>
                                        <h3>Payment Id</h3>
                                        <p>{booking ? booking.paymentId : 'N/A'}</p>
                                    </div>

                                    <div className='detail'>
                                        <h3>Show Date</h3>
                                        <p>{booking ? booking.showDate : 'N/A'}</p>
                                    </div>
